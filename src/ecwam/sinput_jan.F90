...
#include "wsigstar.intfb.h"
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL,NANG_PARAM) :: UFAC1, UFAC2
      REAL(KIND=JWRB), DIMENSION(KIJL,NANG_PARAM) :: TEMPD
      REAL(KIND=JWRB), DIMENSION(KIJL,NANG_PARAM,2) :: GAM0

      LOGICAL, DIMENSION(KIJL,NANG_PARAM) :: LZ
