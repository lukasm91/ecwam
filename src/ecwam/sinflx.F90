...
REAL(KIND=JWRB), DIMENSION(KIJL,NANG_PARAM) :: HALPHAP_WD
REAL(KIND=JWRB), DIMENSION(KIJL,NANG,NFRE) :: HALPHAP_FLWD

REAL(KIND=JPHOOK) :: ZHOOK_HANDLE
REAL(KIND=JWRB), DIMENSION(KIJL) :: RNFAC
REAL(KIND=JWRB), DIMENSION(KIJL) :: RAORW  !! RATIO AIR DENSITY TO WATER DENSITY.
...
IF(LUPDTUS) THEN
  ...
  DO IJ=KIJS,KIJL
  CALL AIRSEA (HALP(IJ), WSWAVE(IJ), WDWAVE(IJ), TAUW(IJ), TAUWDIR(IJ), RNFAC(IJ),  &
