...
!$OMP INTFLDS_FIELD, SRC_CONTRIBS)
    DO ICHNK = 1, NCHNK
      ...
      CALL IMPLSCH (1, NPROMA_WAM, SRC_CONTRIBS%FL1,   &
 &                  WVPRPT_FIELD%WAVNUM, WVPRPT_FIELD%CGROUP, WVPRPT_FIELD%CIWA, &
 &                  WVPRPT_FIELD%CINV, WVPRPT_FIELD%XK2CG, WVPRPT_FIELD%STOKFAC, &
 &                  WVENVI_FIELD%EMAXDPT, WVENVI_FIELD%INDEP, &
 &                  WVENVI_FIELD%DEPTH, WVENVI_FIELD%IOBND, WVENVI_FIELD%IODP, &
 &                  FF_NOW_FIELD%AIRD, FF_NOW_FIELD%WDWAVE, FF_NOW_FIELD%CICOVER, &
 &                  FF_NOW_FIELD%WSWAVE, FF_NOW_FIELD%WSTAR, &
 &                  FF_NOW_FIELD%UFRIC, FF_NOW_FIELD%TAUW, FF_NOW_FIELD%TAUWDIR, &
 &                  FF_NOW_FIELD%Z0M, FF_NOW_FIELD%Z0B, FF_NOW_FIELD%CHRNCK, &
 &                  FF_NOW_FIELD%CITHICK, &
 &                  WAM2NEMO_FIELD%NEMOUSTOKES, WAM2NEMO_FIELD%NEMOVSTOKES, WAM2NEMO_FIELD%NEMOSTRN, &
 &                  WAM2NEMO_FIELD%NPHIEPS, WAM2NEMO_FIELD%NTAUOC, WAM2NEMO_FIELD%NSWH, &
 &                  WAM2NEMO_FIELD%NMWP, WAM2NEMO_FIELD%NEMOTAUX, WAM2NEMO_FIELD%NEMOTAUY, &
 &                  WAM2NEMO_FIELD%NEMOWSWAVE, WAM2NEMO_FIELD%NEMOPHIF, &
 &                  INTFLDS_FIELD%WSEMEAN, INTFLDS_FIELD%WSFMEAN, &
 &                  INTFLDS_FIELD%USTOKES, INTFLDS_FIELD%VSTOKES, INTFLDS_FIELD%STRNMS, &
 &                  INTFLDS_FIELD%TAUXD, INTFLDS_FIELD%TAUYD, INTFLDS_FIELD%TAUOCXD, &
 &                  INTFLDS_FIELD%TAUOCYD, INTFLDS_FIELD%TAUOC, INTFLDS_FIELD%PHIOCD, &
 &                  INTFLDS_FIELD%PHIEPS, INTFLDS_FIELD%PHIAW, &
 &                  SRC_CONTRIBS%MIJ, SRC_CONTRIBS%XLLWS )
