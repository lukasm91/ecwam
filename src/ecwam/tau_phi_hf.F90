...
#include "omegagc.intfb.h"
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(IN) :: AIRD, RNFAC
      REAL(KIND=JWRB), DIMENSION(KIJL, NANG), INTENT(IN) :: COSWDIF, SINWDIF2
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(INOUT) :: UST
      REAL(KIND=JWRB), DIMENSION(KIJL), INTENT(OUT) :: TAUHF, PHIHF
      ...
      REAL(KIND=JWRB), DIMENSION(KIJL) :: XKS, OMS
      REAL(KIND=JWRB), DIMENSION(KIJL) :: SQRTZ0OG, ZSUP, ZINF, DELZ
      REAL(KIND=JWRB), DIMENSION(KIJL) :: TAUL, XLOGGZ0, SQRTGZ0
      REAL(KIND=JWRB), DIMENSION(KIJL) :: USTPH
